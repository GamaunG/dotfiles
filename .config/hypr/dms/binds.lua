...
hl.bind("SUPER + SHIFT + T", hl.dsp.exec_cmd("alacritty --class=floating"))
hl.bind("SUPER + E", hl.dsp.exec_cmd("nautilus"))
hl.bind("SUPER + SHIFT + R", hl.dsp.exec_cmd("~/.local/bin/ocr"))
hl.bind("SUPER + P", hl.dsp.exec_cmd("~/.local/bin/wofipass"))
hl.bind("CTRL + SHIFT + R", hl.dsp.exec_cmd("killall -SIGUSR1 gpu-screen-recorder"))
...
hl.bind("SUPER + SHIFT + DELETE", hl.dsp.exec_cmd("hyprctl kill"))
...
hl.bind("SUPER + O", hl.dsp.window.pin({ action = "toggle" }))
hl.bind("SUPER + W", hl.dsp.group.toggle())
hl.bind("SUPER + SHIFT + W", hl.dsp.exec_cmd("dms ipc call window-rules toggle"))
hl.bind("SUPER + S", hl.dsp.exec_cmd("dms ipc call hypr toggleOverview"))
...
hl.bind("SHIFT + ALT + TAB", hl.dsp.window.cycle_next({ prev = true }))
...
hl.bind("SUPER + C", hl.dsp.layout("focus"))
hl.bind(
	"SUPER + R",
	layout_bind({
		scrolling = hl.dsp.layout("colresize"),
		dwindle = hl.dsp.layout("togglesplit"),
	})
)
...
hl.bind("SUPER + CTRL + down", hl.dsp.window.resize({ x = 0, y = 100, relative = true }), { repeating = true })
hl.bind("SUPER + CTRL + up", hl.dsp.window.resize({ x = 0, y = -100, relative = true }), { repeating = true })
hl.bind("SUPER + CTRL + right", hl.dsp.window.resize({ x = 100, y = 0, relative = true }), { repeating = true })

-- === Screenshots ===
hl.bind("Print", hl.dsp.exec_cmd("~/.config/hypr/scripts/grimblast --cursor save screen"))
hl.bind("CTRL + Print", hl.dsp.exec_cmd("~/.config/hypr/scripts/grimblast --cursor copy screen -"))
hl.bind("SHIFT + Print", hl.dsp.exec_cmd("~/.config/hypr/scripts/grimblast --freeze save area"))
hl.bind("CTRL + SHIFT + Print", hl.dsp.exec_cmd("~/.config/hypr/scripts/grimblast --freeze copy area -"))
hl.bind("ALT + Print", hl.dsp.exec_cmd("~/.config/hypr/scripts/grimblast --cursor save active"))
hl.bind("CTRL + ALT + Print", hl.dsp.exec_cmd("~/.config/hypr/scripts/grimblast --cursor copy active -"))
...
hl.bind("SUPER + SHIFT + ALT + P", hl.dsp.submap("passthru"))
hl.define_submap("passthru", function()
	hl.bind("SUPER + SHIFT + ALT + ESCAPE", hl.dsp.submap("reset"))
end)
