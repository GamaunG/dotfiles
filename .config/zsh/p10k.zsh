# Generated by Powerlevel10k configuration wizard on 2024-02-24 at 18:16 MSK.
...
() {
  ...
  [[ $SSH_TTY ]] && typeset -g POWERLEVEL9K_BACKGROUND=052 || typeset -g POWERLEVEL9K_BACKGROUND=236
  ...
  # really need it.
	# hot reload refresh update realtime real time
