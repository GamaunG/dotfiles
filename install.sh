...
if [ $(command -v pacman) ]; then
	...
	hyprland="hyprland hyprlock hypridle hyprpicker hyprpaper hyprutils xdg-desktop-portal-gtk xdg-desktop-portal-hyprland dms-shell-hyprland cliphist wofi qt6-wayland qt5-wayland polkit-gnome"
...
installtheme() {
	...
	cd "$DLDIR"
	$wget https://github.com/lassekongo83/adw-gtk3/releases/download/v5.7/adw-gtk3v5.7.tar.xz
	mkdir -p adw
	tar -xf adw-gtk3v5.7.tar.xz --directory=./adw
