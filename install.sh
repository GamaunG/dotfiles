...
if [ $(command -v pacman) ]; then
	...
	hyprland="hyprland hyprpicker hyprutils xdg-desktop-portal-gtk xdg-desktop-portal-hyprland dms-shell-hyprland cliphist wofi qt6-wayland qt5-wayland polkit-gnome"
